...
var $author$project$Main$classifyDevice = function (window) {
	return {
		_class: function () {
			...
			return (shortSide < 600) ? $mdgriffith$elm_ui$Element$Phone : ((longSide <= 900) ? $mdgriffith$elm_ui$Element$Tablet : (((longSide > 900) && (longSide <= 1920)) ? $mdgriffith$elm_ui$Element$Desktop : $mdgriffith$elm_ui$Element$BigDesktop));
		}(),
...
var $author$project$Theme$markdownOptions = {
...
var $author$project$Desktop$viewPage = function (page) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Desktop$viewTitle(page.title),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$Font$alignLeft]),
						$mdgriffith$elm_ui$Element$html(
							A3(
								...
								$author$project$Theme$markdownOptions,
								_List_fromArray(
									[
				...
				function () {
					...
					var content = _List_fromArray(
						[
							...
							switch (_v0.$) {
								case 'Home':
									return $author$project$Desktop$viewHomeRoute(model);
								case 'About':
									return $author$project$Desktop$viewPage($author$project$Pages$about);
								default:
									return $author$project$Desktop$viewPage($author$project$Pages$support);
							}
						}()
						]);
...
var $author$project$Phone$viewPage = function (page) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Phone$viewTitle(page.title),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$Font$alignLeft]),
				...
				function () {
					...
					var content = _List_fromArray(
						[
							...
							switch (_v0.$) {
								case 'Home':
									return $author$project$Phone$viewHomeRoute(model);
								case 'About':
									return $author$project$Phone$viewPage($author$project$Pages$about);
								default:
									return $author$project$Phone$viewPage($author$project$Pages$support);
							}
						}()
						]);
					return A2($mdgriffith$elm_ui$Element$column, styles, content);
